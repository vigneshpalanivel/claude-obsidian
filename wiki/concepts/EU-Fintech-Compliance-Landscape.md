...
internal_artifacts:
  - path: ".raw/InnBlockchain/EU Compliance/EU-Compliance-Landscape.md"
    ...
    purpose: "Standalone InnBlockchain-branded client-shareable artifact (frontmatter stripped, H1 shortened to 'EU Compliance Landscape'); body content kept in sync with this wiki concept. 2026-05-24 sync: AML scoping precision (AMLR + AMLD6 coupling, AMLA direct-supervision narrowing, per-segment obliged-entity basis) + EUR-Lex Primary Sources section + DORA two-pathway framing reconciled (Seg 1 RWA via MiFID-firm/DLT Pilot pathway + Seg 2-10 CASP pathway)"
---
...
| EU Listing Act (Prospectus Reg amendments, phased 4 Dec 2024 / 5 Mar 2026 / 5 Jun 2026) | Regulation (EU) 2024/2809 | https://eur-lex.europa.eu/eli/reg/2024/2809/oj |
