...
> - Primary obligations: **Prospectus Regulation** + **MAR** (inside-information disclosure once admitted to trading — Listing Act narrowed Art 17 protracted-process disclosure to final-event-only from 4 Dec 2024 and raised the PDMR threshold to €20k, MS opt-up €50k) + national corporate disclosure rules.
> - **How MAR reaches the issuer — conditional, instrument-based, not entity-based.** MAR does not attach to "operating a venue"; it attaches to the *instrument* the moment the token is **admitted to — or pending admission to — trading** on an EU RM / MTF / OTF / SME growth market / **DLT MTF / DLT TSS**. Once that trigger fires, MAR binds the issuer **directly** — **Art 17** (public disclosure of inside information), **Art 18** (insider lists), **Art 19** (PDMR notifications + 30-day closed periods) — even when a *third party* runs the venue. This is distinct from the venue operator's **Art 16** (prevention/detection + STORs) duties. A pure issuer whose tokens never list (locked / redemption-to-issuer only) is **outside MAR scope entirely** — that is the genuine pure-issuer lane.
...
> - **MiFID III additions (on top of MiFID II):** consolidated tape — venue must report all executed trades to the EU consolidated tape provider (**Jun 2026**) · expanded MiFIR Art. 26 transaction reporting fields — more data per trade report (**Apr 2026**) · pre-trade transparency narrowing — fewer waiver exemptions under the amended MiFIR equity-transparency regime (waivers under MiFIR Arts 4–5, incl. the single volume cap replacing the double volume cap), more quotes must be made public (**Sep 2025 / Mar 2026**). PFOF ban does NOT apply to the venue role — it targets broker order-routing, not the venue itself.
>
...
> - Primary obligations: **MiFID II investment-firm authorization** (with the specific permissions depending on which services are provided) + **MiFIR Art. 26** transaction reporting on every executed trade + **MiFID II Art. 27** best execution + **MiFID II Arts 24–25** disclosure and suitability + **IFR/IFD** capital adequacy + **product governance** (Art. 16(3)). Systematic Internalisers additionally owe pre-trade quoting and transparency under **MiFIR Arts 14–20** (SI-specific regime — narrower than the full Arts 3–23 venue regime).
...
>
> **Summary — obligations by role:**
>
> | Role | Trigger | Primary obligations | MiFID III |
> |---|---|---|---|
> | **Issuer** | Mints + offers the token | Prospectus Regulation · MAR · national disclosure | Not applicable |
> | **Venue Operator** (DLT MTF/SS/TSS) | Investor-to-investor matching (MiFID II Art 4(1)(22)) | MiFID II venue authorization · DLT Pilot licence · MiFIR Arts 3–23 · MiFIR Art 26 · DORA · AMLR | Consolidated tape (Jun 2026) · expanded Art 26 (Apr 2026) · transparency narrowing — **no PFOF** |
> | **Dealer / SI** | Own-book counterparty (MiFID II Art 4(1)(20)) or advice | MiFID II investment-firm authorization · MiFIR Art 26 · MiFID II Art 27 best execution · MiFID II Arts 24–25 · IFR/IFD · product governance (Art 16(3)) · SI: MiFIR Arts 14–20 quoting | PFOF ban (Jun 2026) · expanded Art 26 (Apr 2026) |
...
>
> **Step 2 — Does the AIF also need a retail EU passport? (ELTIF 2.0 check)**
>
> | Scenario | Outcome |
> |---|---|
...
| **AIFMD / UCITS** | Two distinct fund-manager authorisation regimes. **AIFMD** (Dir 2011/61/EU): governs managers of AIFs — any pooled vehicle that raises capital from several investors to invest per a defined investment policy for their collective benefit, with no general commercial/industrial purpose. Tokenised fractional real-estate / private-credit / multi-asset vehicles with passive investors qualify; their units are MiFID Annex I C(3) financial instruments. Below-threshold exemption: AUM ≤€100M (leveraged) / ≤€500M (unleveraged) — sub-threshold registered AIFM, no full authorisation required. **UCITS** (Dir 2009/65/EC): separate authorisation regime for open-ended retail funds. Key distinctions from AIFMD: (a) UCITS ManCo license — not an AIFM license; (b) eligible assets strictly limited to liquid securities — transferable securities, money-market instruments, deposits, FDIs only; **no real estate, commodities, or loans**; (c) **5/10/40 diversification rule**; (d) PRIIPs KID mandatory for retail from 1 January 2023; (e) cross-border passport via 10-working-day NCA notification. **A fund is either a UCITS or an AIF — never both.** | AIFMD in force since 22 Jul 2013; UCITS in force since 2010 (consolidated Dir 2009/65/EC). **AIFMD II (Dir (EU) 2024/927) transposition by 16 Apr 2026** — mandatory selection of ≥2 liquidity-management tools (Annex V) for **all open-ended AIFs**, and via the parallel UCITS amendment for **all open-ended UCITS**, from **16 October 2026** | National-set — administrative fines + loss of authorisation; marketing a fund without an authorised AIFM / UCITS ManCo is prohibited |
| **ELTIF 2.0** | European Long-Term Investment Fund — a voluntary product label (Regulation (EU) 2023/606 amending Reg 2015/760) applied on top of an AIFMD-authorised EU AIF, granting an EU-wide marketing passport including retail access. ELTIF 2.0 material changes: (1) min eligible assets 70 % → **55 %**; (2) borrowing **50 % NAV retail / 100 % NAV professional-only**; (3) concentration limits (Art 13) **and the Art 15 cross-holding limit removed for professional-only ELTIFs**; (4) eligible assets broadened to UCITS/EU AIF units + European Green Bonds; (5) matching mechanism for secondary exits (Art 19.2a); (6) local facilities requirement **removed**; (7) **€10k minimum ticket removed**; (8) QPU market cap ≤€1.5B; (9) master-feeder permitted. Two authorisations required: AIFMD licence for the manager + ELTIF NCA fund authorisation (2-month decision, Art 5(3)). **Level-2 rulebook: Commission Delegated Regulation (EU) 2024/2759 (ELTIF RTS), compliance from 26 Oct 2024 — sets the redemption policy, liquidity-management tools, the matching mechanism (Art 19(2a)), hedging-derivative use, asset disposal, and cost disclosure.** | Applicable from **10 January 2024** (Reg 2023/606, OJ L 80/1, 20 Mar 2023) | NCA revocation of ELTIF authorisation; penalties follow AIFMD national framework of home Member State |
...
| **MAR (Market Abuse Regulation)** | Inside-information disclosure, insider lists, PDMR transactions, market-manipulation prohibition, buy-back safe harbour — applies once a financial instrument is admitted (or pending admission) to trading on an EU RM, MTF, OTF, SME growth market, DLT MTF, or DLT TSS. The *ongoing-disclosure* counterpart to the Prospectus Regulation's *offer-time* disclosure. | In force since 3 Jul 2016; **Listing Act (Reg 2024/2809) amendments from 4 Dec 2024** — Art 17 protracted-process narrowed to *final event only*; PDMR threshold raised €5k → €20k (MS opt-up €50k); further amendments 5 Jun 2026 | Art 30(2): **2% of total annual turnover** (min €2.5M) for Art 17 breaches; **0.8%** (min €1M) for Arts 18-19; **≥3× profits gained / losses avoided** (applies to legal and natural persons) |
| **EU Listing Act** | Horizontal reform package (Reg (EU) 2024/2809 + Dir (EU) 2024/2810 + Dir (EU) 2024/2811) amending Prospectus Reg, MAR, MiFIR, and MiFID II. Not a standalone regime — every obligation lives in an amended host regulation. | Three-cliff: **4 Dec 2024** (MAR amendments, fungibility 30%, supplement withdrawal 3 WD) / **5 Mar 2026** (EU Follow-on + EU Growth Issuance Prospectus) / **5 Jun 2026** (single €12M threshold); Dir 2024/2810 transposition **5 Jun 2026**; Dir 2024/2811 multi-vote shares **5 Dec 2026** | Penalties live in the amended host regulation (Prospectus Art 38(2) / MAR Art 30(2)) |
| **DLT Pilot Regime** | Regulatory sandbox for on-chain tokenized-securities trading and settlement — DLT MTF (trading), DLT SS (settlement), DLT TSS (combined). Grants exemptions from MiFIR/CSDR for on-chain infrastructure, subject to hard size caps: per-instrument (shares <€500m market cap, bonds <€1bn issuance) and an aggregate **€6bn** DLT-financial-instrument market-value ceiling (transition strategy triggered at **€9bn**) — the main reason for low uptake. **ESMA's Art 14 review report (25 Jun 2025) recommended making the regime permanent with tiered/flexible thresholds and broader eligible assets (incl. illiquid/complex); Commission follow-up report due mid-2026 — not yet enacted.** | Regulation (EU) 2022/858 in force; 6-year sandbox window per authorisation; **~10 pending applications** as of 2026 (including Securitize, Spain) | Sandbox exemptions revocable by NCA; operators revert to full MiFIR/CSDR obligations on expiry |
...
> - **DORA** (ICT operational resilience) — always, via the MiFID investment-firm / DLT Pilot trading-venue / CSD pathway (DORA Art. 2(e),(g),(i)); the firm does NOT need to be a CASP to be caught.
> - **AML/AMLA** (AMLR obliged entity) — always; CDD + KYC + STR. **TFR Travel Rule does NOT apply** to MiFID-classified tokens (not crypto-assets under MiCA); only a CASP side, if present, triggers TFR.
> - **eIDAS 2.0** — investor KYC must accept the EUDI Wallet as a relying party; the acceptance obligation (Art 5f(2)) phases in ~2026–2027 (36 months after the Commission implementing acts; EUDI Wallet availability targeted end-2026), not a fixed 31 Dec 2026 date.
...
> [!info] On the horizon — recently adopted (not yet applicable) + proposed changes to track
> - **T+1 settlement — Regulation (EU) 2025/2075** (adopted Oct 2025): the EU settlement cycle shortens from T+2 to **T+1 on 11 October 2027** (amends CSDR Art 5). Applies to the **venue / settlement lane** — any admitted tokenized security, and DLT SS/TSS operators. Low practical burden for on-chain platforms (atomic DvP already settles at or below T+1), but now a hard legal obligation rather than a design choice.
> - **Retail Investment Strategy (RIS)** — Member-State-approved **12 Jun 2026** (OJ expected H1 2026; general application **~end-2028**). An omnibus amending **MiFID II, UCITS, AIFMD and PRIIPs**. For RWA/STO it bites on the **retail distribution lane only** (retail tokenized securities, retail ELTIFs): a partial inducements ban, a new "value-for-money" benchmark, a modernised PRIIPs KID, and — most relevant here — an **eased elective-professional test** (portfolio criterion **€500k → €250k** averaged over 3 years, plus a new education/training alternative to the 1-year-experience test). **Professional-only platforms are largely unaffected.** When it applies it shifts the professional/retail gate used throughout this document.
> - **DLT Pilot → permanent regime** — ESMA's Jun 2025 Art-14 review recommended making the Pilot **permanent** with **flexible/tiered caps** and **broader eligible assets** (incl. illiquid/complex); Commission report due mid-2026, **not yet enacted**. If adopted it would remove the €6bn/€9bn ceiling that currently caps RWA/STO on-chain venues.
...
|---|---|
| **Seg 1 — RWA Tokenization** | **MiFID II + Prospectus Regulation** (primary — any token conferring ownership / claim on issuer or underlying asset is a transferable security regardless of yield; MiCA Art. 2(4) carve-out applies) · **AIFMD / UCITS** (conditional but high-frequency — when the token pools capital from multiple investors under a defined investment policy, the token is a *unit in a collective investment undertaking* (MiFID Annex I C(3)) and the vehicle requires an authorised **AIFM** (or UCITS ManCo); per ESMA's Mar 2025 guidelines, a token giving a proportional share of pooled returns + redemption for a share of portfolio value = CIU unit; carve-outs are narrow — genuine day-to-day holder control, or a genuine operating business / direct tokenized debt / direct legal co-ownership; see the AIFMD callout above) · **ELTIF 2.0** (if the AIF manager seeks a retail EU passport for illiquid long-term assets — Reg (EU) 2023/606, applicable 10 Jan 2024; ≥55 % eligible assets; requires AIFMD authorisation as prerequisite) · **MiFID III** (if operating a DLT MTF / SS / TSS — expanded reporting Apr 2026, transparency Mar 2026, PFOF ban Jun 2026; pure issuers not in scope) · **MAR** (once tokens are admitted or pending admission to trading on an EU venue / DLT MTF / DLT TSS — issuer Art 17 disclosure, Art 18 insider lists, Art 19 PDMR, Arts 12-15 manipulation prohibition; venue Art 16 + STORs) · **DLT Pilot Regime** (DLT MTF / SS / TSS — the real on-chain infra path, not MiCA) · **DORA** (ICT resilience — always, via the MiFID investment-firm / DLT Pilot venue / CSD pathway, DORA Art. 2(e),(g),(i)) · **AML/AMLA** (CDD + KYC + STR via AMLR as a MiFID II investment firm; **TFR Travel Rule does NOT apply** — only the CASP side, if present, triggers it; AMLA direct supervision only if a "selected obliged entity" — operating in ≥6 Member States + high residual risk, AMLR Art 12–13) · **eIDAS 2.0** (investor KYC must accept the EUDI Wallet as a relying party; Art 5f(2) acceptance obligation phasing in ~2026–2027) · **GDPR** (investor personal data) · **EU AI Act** (if AI used for asset valuation or oracle inputs) · **MiCA** (only if the token is an Asset-Referenced Token, or the firm also services non-MiFID crypto-assets) |

### FinTech — WealthTech (RWA / STO / Tokenized Securities)

| Segment | EU Compliance Obligations |
|---|---|
| **WealthTech (RWA / STO / Tokenized Securities)** | **MiFID II / III** (primary — financial instrument classification; investment services authorization) · **Prospectus Regulation** (for any token conferring ownership / claim on issuer or underlying asset) · **AIFMD / UCITS** (if the tokenised product is a pooled vehicle — the token is a *unit in a collective investment undertaking* (MiFID Annex I C(3)) and an authorised AIFM / UCITS ManCo is required; see Seg 1 + the Fund Structure section) · **ELTIF 2.0** (conditional — if the AIF manager seeks an EU-wide retail marketing passport for illiquid long-term assets: ELTIF label layered on AIFMD; ≥55 % eligible assets; two authorisations — AIFM licence + per-fund ELTIF NCA authorisation) · **MAR** (ongoing-disclosure counterpart to Prospectus — triggers once the tokenised security is admitted or pending admission to trading) · **DLT Pilot Regime** (if building DLT MTF/SS/TSS) · **DORA** (ICT resilience — WealthTech investment firms are explicitly in DORA Art. 2 scope) · **AML/AMLA** (investment firm → AMLR obliged entity; AMLA direct supervision only if a "selected obliged entity" — ≥6 Member States + high residual risk, AMLR Art 12–13) · **eIDAS 2.0** (investor KYC must accept the EUDI Wallet; acceptance obligation phasing in ~2026–2027) · **GDPR** (investor personal data) · **EU AI Act** (if AI used in portfolio or risk management) · **MiCA** (only if the firm also services non-MiFID crypto-assets — stablecoins, utility tokens — on the side) |
...
DLT Pilot Regime ───► On-chain tokenized securities trading + settlement infra
                       (DLT MTF / SS / TSS — sandbox path; ESMA recommended a
                       permanent regime + flexible caps in its Jun 2025 review —
                       not yet enacted)
```
...
| **MAR** | Seg 1 RWA primary (instrument-based — triggers once tokens admitted or pending admission to trading on EU venue / DLT MTF / DLT TSS) | WealthTech primary (issuer + venue side once admitted); ExchangeTech (venue Art 16 surveillance + STORs if admitting financial instruments) |
...
Per-regulation compliance checklists live in the raw artifact's `Checklist/` folder. Most-relevant for RWA/STO work:

| Regulation | Checklist | Seg 1 | WealthTech |
|---|---|---|---|
| MiFID II | mifid2-checklist.md | primary | primary |
| MiFID III | mifid3-checklist.md | if venue/dealer | if venue/dealer |
| MiFIR | mifir-checklist.md | if venue/dealer | if venue/dealer |
| AIFMD | aifmd-checklist.md | if pooled vehicle | if pooled vehicle |
| AIFMD II | aifmd2-checklist.md | if pooled vehicle | if pooled vehicle |
| UCITS | ucits-checklist.md | rare (liquid retail only) | if liquid retail fund |
| ELTIF 2.0 | eltif-checklist.md | if retail EU passport | if retail EU passport |
| ELTIF 2.0 RTS (Level 2 — redemption / matching / LMTs) | eltif-rts-checklist.md | if open-ended / matching window | if open-ended / matching window |
| Prospectus Regulation | prospectus-checklist.md | primary (public offer) | primary (public offer) |
| MAR | mar-checklist.md | once admitted to trading | once admitted to trading |
| EU Listing Act | eu-listing-checklist.md | if EU public-market access | if EU public-market access |
| DLT Pilot Regime | dlt-pilot-checklist.md | if on-chain venue/settlement | if on-chain venue/settlement |
| T+1 settlement (from 11 Oct 2027) | t1-settlement-checklist.md | if venue/settlement | if venue/settlement |
| DORA | dora-checklist.md | always (investment firm / venue) | always (investment firm) |
| AML / AMLA | aml-checklist.md | always (obliged entity) | always (obliged entity) |
| eIDAS 2.0 | eidas2-checklist.md | investor KYC (Wallet acceptance ~2026–2027) | investor KYC (Wallet acceptance ~2026–2027) |
| GDPR | gdpr-checklist.md | always | always |
| MiCA | mica-checklist.md | only if ART or CASP side | only if non-MiFID crypto side |
| TFR (Travel Rule) | tfr-checklist.md | only if CASP side | only if CASP side |
| RIS *(upcoming ~2028, pre-OJ)* | ris-checklist.md | if retail distribution | if retail distribution |
...
| ELTIF 2.0 RTS (Level 2 — redemption / LMTs / matching mechanism) | Commission Delegated Regulation (EU) 2024/2759 | https://eur-lex.europa.eu/eli/reg_del/2024/2759/oj |
| DLT Pilot Regime | Regulation (EU) 2022/858 | https://eur-lex.europa.eu/eli/reg/2022/858/oj |
| T+1 settlement cycle (amends CSDR Art 5) | Regulation (EU) 2025/2075 | https://eur-lex.europa.eu/eli/reg/2025/2075/oj |
...
**On the horizon (approved, not yet in the OJ):** Retail Investment Strategy (RIS) — an amending Directive + Regulation over MiFID II / UCITS / AIFMD / PRIIPs; Member-State-approved 12 Jun 2026, OJ expected H1 2026, general application ~end-2028. Commission proposal: COM(2023) 279 final — https://eur-lex.europa.eu/legal-content/EN/TXT/?uri=CELEX:52023PC0279.
...
- **ESMA** (MiFID II/III, AIFMD/UCITS, DLT Pilot, Prospectus, MAR): https://www.esma.europa.eu
  - DLT Pilot Regime — Article 14 review report (25 Jun 2025; recommends a permanent regime + tiered/flexible thresholds + broader eligible assets): https://www.esma.europa.eu/sites/default/files/2025-06/ESMA75-117376770-460_Report_on_the_functioning_and_review_of_the_DLTR_-_Art.14.pdf
...
See: [[EU-Fintech-Compliance-Landscape]] | [[ELTIF-2.0]] | [[MiFID-II]] | [[DLT-Pilot-Regime]] | [[Asset-Tokenization-RWA]] | [[ESMA]]
