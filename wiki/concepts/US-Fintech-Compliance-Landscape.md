...
internal_artifacts:
  - path: ".raw/InnBlockchain/US Compliance/US-Compliance-Landscape.md"
    hash: "254a3ec743648bc33d3ee207f6a065fd"
    registered: 2026-05-23
    derived_from: this wiki concept
    purpose: "Standalone InnBlockchain-branded client-shareable artifact (frontmatter stripped, H1 shortened to 'US Compliance Landscape'); body content tracks this wiki concept as canonical — keep them in sync if either changes"
---
...
| **Reg D 506(c) / Reg A+ / Reg CF / [[Regulation-S]]** | Seg 1 RWA (primary — Reg D + Reg S concurrent dominant), Seg 6 Token Launch (primary — same dual-tranche pattern); Seg 7 DAO if governance token sold | WealthTech (primary); BankTech, InsurTech if raising primary capital via tokenized vehicle |
