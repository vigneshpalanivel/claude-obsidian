...
| **Reg D 506(c) / Reg A+ / Reg CF / [[Regulation-S]]** | Seg 1 RWA (primary — Reg D + Reg S concurrent dominant; Rule 905 bridges to [[Rule-144]] for Cat 3 domestic-issuer equity; [[Real-Estate-RWA-Reg-S-Implementation]] = real-estate reference architecture, [[Real-Estate-RWA-Reg-S-Affiliate-Addendum]] = optional affiliate machinery extension), Seg 6 Token Launch (primary — same dual-tranche pattern); Seg 7 DAO if governance token sold | WealthTech (primary); BankTech, InsurTech if raising primary capital via tokenized vehicle |
