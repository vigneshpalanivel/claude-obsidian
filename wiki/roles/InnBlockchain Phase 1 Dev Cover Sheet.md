...
> **What this is:** Your slice of [[InnBlockchain - Phase 1 Execution Playbook]] for daily/weekly use. Task detail + cross-role context live in the parent playbook — open the `[[#anchor]]` links to drill in. ~30 task touchpoints across 4 workstreams.
