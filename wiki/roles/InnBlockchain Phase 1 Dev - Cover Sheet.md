...
LP Gates 1 + 2 + 3 build (**CRITICAL PATH** — single point of failure for Speed Mode) · email-capture form integration · GA4 + UTM wiring · 301 redirect implementation · sitemap + Search Console submission · **academy blog technical SEO setup** (WordPress schema · sitemap · plugin · author pages) · LP hero image integration coordinated with Sudharshini + Britto + Designer.
...
| Week | What you ship |
|---|---|
| **W1 Day 1** | Kick off LP Gates 1 + 2 + 3 sprint |
| **W1–W2** | Academy blog technical SEO setup (before article publish volume ramps) |
| **EOD W3** | LP Gates 1 + 2 + 3 live — all verified not 404 |
| **EOD W3** | Email-capture form integration with CRM operational |
| **EOD W3** | GA4 + UTM events firing for all gate LPs |
| **W3 onwards** | LP citation health checks coordinated with Sudharshini + Britto (monthly) |
| **W11–W12** | eIDAS gated PDF landing page built |
| **Ongoing** | LP hero images integrated when Sudharshini + Britto/Designer hand off |
...
- GA4 / email-capture integration blockers → **Sudharshini + Britto** (your day-to-day liaison — they own the configuration choices)
- Hero image hand-off blocked → **Designer** (via Sudharshini + Britto for coordination)
...
- LP copy drafting → **Sudharshini + Britto** (with Vignesh review for regulatory framing)
- LP on-page SEO + monthly citation probes → **Sudharshini + Britto**
- LP hero image design → **Designer** (you integrate; don't design)
- CRM / Sales Nav / outreach tooling → **SP**
- Newsletter platform decision → **Sudharshini + Britto + Vignesh** (W10 revisit)
