---
tags: [health, profile, index]
created: 2026-07-10
status: active
---

# Health Profile — Vignesh

The single canonical profile. **Read this first for any health/food/medication/symptom question**, then drill into the linked topic files for depth. See [[README]] for the mandatory read-before-answer rule.
...
## Active Conditions (Jul 2026)

| Condition | Status | Doctor | Detail |
|-----------|--------|--------|--------|
...
> Anxiety carries no pharmaceutical backstop since ~Jan 2026 — food, sleep, and movement do all the work now. This raises the stakes on lifestyle.
...
| Marker | Value | Note |
|--------|-------|------|
| **HDL** | 32 mg/dL (Feb 2026) | Chronically low (ref 40–60) — lifestyle intervention needed |
| **Vitamin D** | 9 → 29.95 ng/mL | Severe → insufficient; keep supplementing (ref >30) |
| **CRP** | 27.6 → 5.0 → 0.10 | Sulfasalazine resolved inflammation decisively |
| **PICA vascular loop** | MRI 2020 | Indents right 7th nerve — neurovascular conflict, monitor |
| **BP** | 90/60, 100/60 episodes | Orthostatic hypotension risk — stand up slowly |
| Sugar / thyroid / kidney / liver / CBC | Normal | As of Feb 2026 |

---

## ⛔ Hard Constraints for Food & Lifestyle Answers
...
|--------|-----------|----------|
| Dr. K Arun Ganesh MS(ENT) | ENT / Skull Base | KRK ENT Care, K.K.Nagar, Madurai |
| Dr. S N Karthik DM(Neuro) | Neurology | Sri Nerve Clinic, Thiruppalai, Madurai |
| Dr. Rajapandian K | Spine & Joint | Apollo Hospitals, Madurai |
| Dr. R Sabrin Sonjeev Ross | Psychiatry | Ahana Hospitals, Madurai |

---

## Topic Files (drill down here)
