...
- [[RWA-STO-Smart-Contract-Design]] — dev companion to the RWA/STO landscape: paired compliance-requirements (on-chain vs off-chain, Article-mapped) + CTO engineering design (chain selection, off-chain services, build phasing). ERC-3643/T-REX; permissioned BFT EVM; valuation-oracle = #1 risk; TFR N/A; not MiCA (status: current)
