...
- [[RWA-STO-EU-Compliance-Criteria]] — per-regulation APPLICABILITY gates: 18 Mermaid "does this regime apply?" trees (MiFID II/III, MiFIR, Prospectus, MAR, Listing Act, AIFMD/II, UCITS, ELTIF, DLT Pilot, DORA, AMLR, eIDAS, GDPR, EU AI Act, MiCA, TFR), each ending APPLIES (scope) or does-NOT-apply (reason); sourced from checklist scope sections. Classification trees deliberately excluded (see landscape) (status: current)
