...
- [ ] **Tax law (federal and state)** — federal income tax, FIRPTA (IRC § 1445) for U.S. real estate, §§ 1441/1442 withholding on non-resident distributions, state tax — all apply independent of Reg S. The platform does not implement tax-withholding logic in this scope
