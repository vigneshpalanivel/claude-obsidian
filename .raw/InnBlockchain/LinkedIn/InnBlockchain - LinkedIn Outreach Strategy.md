...
| :--- | :--- | :--- | :--- |
| **Strategic Sam** | CEO / CPO | Compliance risk, regulatory blowback, missing the market window | Active in FinTech Founders groups, posts about product roadmap and market expansion |
| **Technical Tom** | CTO / VP Engineering | Smart contract exploits, audit failures, Web3 talent gap | Active in engineering communities; posts about architecture, stack decisions, hiring |
...
| :--- | :--- | :--- |
| **T1** | Day 0 | Send connection request with personalised note (300 char max) |
| **T2** | Day 1–2 after acceptance | Welcome message — no pitch, open question |
| **T3** | Day 5–7 | Value asset — share relevant content or insight |
...
## ⚙️ 6. Outreach Automation & Tools

Stay within safe limits to protect your account.
...
- Connection Requests: 15–20 (personalised — no bulk)
- Messages: 30–50
