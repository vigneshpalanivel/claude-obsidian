...
# 📣 MPs — Phase 1 Cover Sheet

> **What this is:** Your slice of [[InnBlockchain - Phase 1 Execution Playbook]] for daily/weekly use. Both MPs share this scope; internal allocation of who-does-what between MP1 + MP2 is your operational decision. ~103 task touchpoints across 7 workstreams.

---

## 🎯 What you own (top-level)

LP on-page SEO + GA4 + email-capture coordination · Featured assets ops · LinkedIn Company Page ongoing ops + X (Twitter) ongoing ops · **LinkedIn + X social amplification publishing** · per-platform formatting · AI visual production via Canva / Beautiful.ai / Midjourney / ChatGPT · GA4 dashboard + per-format CTR + monthly review prep · derivative chain production (visual + posting + distribution) · brand template maintenance (Designer builds; you maintain via templates).

## 🗺️ Workstreams you touch

| WS | Role | Anchor |
|---|---|---|
| **WS1 — LP Delivery** | LP on-page SEO + GA4 + email-capture coordination with Dev | [[InnBlockchain - Phase 1 Execution Playbook#WS1 — Landing Page Delivery (CRITICAL PATH)]] |
...
| **WS8 — LinkedIn Organic** | LinkedIn schedules + posts + visuals + Company Page · per-platform formatting (LinkedIn + X — Telegram dropped Phase 1) · LinkedIn output cap enforcement · **Cross-channel cannibalisation matrix enforcement** | [[InnBlockchain - Phase 1 Execution Playbook#WS8 — LinkedIn Organic (Feed + Newsletter)]] · [[InnBlockchain - Phase 1 Execution Playbook#🚦 Cross-channel cannibalisation matrix]] |
...
| **WS15 — Content Repurposing** | AI visual generation + posting + distribution for derivative chain (Tier 1 full · Tier 2 lite · Tier 3 amplify-only) | [[InnBlockchain - Phase 1 Execution Playbook#WS15 — Content Repurposing]] |

## 📅 Timeline that affects you

| Week | What you ship |
|---|---|
| **W1 Day 1** | LP coordination with Dev begins · LinkedIn + X account setup support · Featured asset ops kickoff |
| **W1–W3** | Profile Recategorisation Accelerator scheduling (2 posts/day · 10–15 comments/day) · Featured assets uploaded + pinned |
| **EOD W3** | GA4 events firing · email-capture mechanism integrated with CRM · all Featured assets live |
| **W3 onwards** | Weekly publishing cadence (LinkedIn personal 4–5×/wk · Company Page 3×/wk · X thread 1×/wk per Track A article) |
| **W5+** | Per-format CTR + LinkedIn output cap tracking · cross-pillar Tier 1 3-week cadence enforcement |
| **Monthly (last Fri)** | AI citation probes per [[InnBlockchain - Landing Pages AEO GEO Prompts]] · GA4 dashboard prep · top/bottom articles report |
| **W10** | Newsletter vendor-selection decision (Beehiiv default per WS8 § Vendor-selection decision criteria) |

## 📚 Read first (in this order)

1. [[InnBlockchain - Phase 1 Execution Playbook#🚦 Cross-channel cannibalisation matrix]] — **canonical source for ALL spacing rules** (read this first, every other rule cross-references back here)
...
3. [[InnBlockchain - Phase 1 Execution Playbook#WS15 — Content Repurposing]] — Tier 1/2/3 derivative chain production
4. [[InnBlockchain - Phase 1 Execution Playbook#X (Twitter) — initial setup (one-time, W1)]] — X personal profile + ongoing ops · Phase 1 X presence = Vignesh personal handle only (no corporate handle per rollback)
...
- **Never use MiCA framing on RWA assets** — #1 Carol disqualifier. Applies to LP copy · LinkedIn posts · X posts · visual derivatives. When in doubt, escalate to Vignesh.
- **Apply the Cross-channel cannibalisation matrix on every Mon AM batch approval**. Canonical source: [[InnBlockchain - Phase 1 Execution Playbook#🚦 Cross-channel cannibalisation matrix]]. Most-violated vectors below.
...
- **Never produce Phase 1 articles for Telegram / GitHub gist / HN / Paragraph** — Phase 2/3 only per [[InnBlockchain - Content Repurposing Plan]] (RWA Felix doesn't live on those surfaces).
...
- Regulatory framing uncertainty (MiCA · MiFID II · DLT Pilot questions) → **Vignesh** (same day)
- Content not ready by publish date → **CW + Vignesh**
- LP issues (404 · GA4 not firing · email-capture broken) → **Dev** (build) + **Vignesh** (decisions)
- AI hallucination on slide copy → spot-check escalation per [[InnBlockchain - Phase 1 Execution Playbook#WS13 — Compliance Review Process]]
