...
| Segment | US Compliance Obligations |
|---|---|
| **WealthTech (RWA / STO / Tokenized Securities)** | **Securities Act 1933 + Exchange Act 1934** (primary — financial-instrument classification) · **Investment Advisers Act 1940** (if portfolio management or wrap services) · **Investment Company Act 1940** (if pooled vehicle) · **FINRA membership** (if broker-dealer activity) · **Reg D 506(c) / Reg A+ / Reg CF / Reg S** for token offerings (Reg D + Reg S concurrent structure is the dominant 2024-2026 RWA path for issuers serving both US-accredited and international investors) · **SAB 122** (crypto custody recognition — favorable post-Jan 2025) · **GLBA / Reg S-P** (customer NPI) · **State Blue Sky** for Reg A/CF (Reg D 506 + Reg S federally covered) · **Colorado AI Act** (if AI in portfolio/risk; Jun 2026, stayed) |
...
| **Reg D 506(c) / Reg A+ / Reg CF / Reg S** | Seg 1 RWA (primary — Reg D + Reg S concurrent dominant), Seg 6 Token Launch (primary — same dual-tranche pattern); Seg 7 DAO if governance token sold | WealthTech (primary); BankTech, InsurTech if raising primary capital via tokenized vehicle |
