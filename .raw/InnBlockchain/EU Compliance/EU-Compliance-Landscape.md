...
> - Primary obligations: **Prospectus Regulation** + **MAR** (inside-information disclosure once admitted to trading — Listing Act narrowed Art 17 protracted-process disclosure to final-event-only from 4 Dec 2024 and raised the PDMR threshold to €20k) + national corporate disclosure rules.
